...
<div class="icon">
    ...
    <span class="number"><?php echo
        count($this->session->userdata('cart_items')); ?></span>
</div>
...
<div class="dropdown course-list-dropdown corner-triangle top-right" style="display: none;"> <!-- Just remove the display none from the css to make it work -->
	<div class="list-wrapper">
		<div class="item-list">
			<ul>
				<?php foreach ($this->session->userdata('cart_items') as $key => $cart_item):
                    $course_details = $this->crud_model->get_course_by_id($key)->row_array();
					...
					<li>
						<div class="item clearfix">
							<div class="item-image">
                                <a href="">
                                    <img src="<?php echo $this->crud_model->get_course_thumbnail_url($key);?>" alt="" class="img-fluid">
                                </a>
							</div>
							<div class="item-details">
								<a href="">
									<div class="course-name"><?php echo $course_details['title']; ?></div>
									<div class="instructor-name"><?php echo $instructor_details['student_first_name'].' '.$instructor_details['student_last_name']; ?></div>
