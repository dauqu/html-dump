<!DOCTYPE html>
<head>
    <title><?php echo get_phrase('live_class'); ?> : <?php echo $schdetails['title']; ?></title>
    <meta charset="utf-8" />
    ...
    <div class="container">
        <div class="navbar-header" style="padding: 0px !important;">
            <a class="navbar-brand" href="#">
                ...
                <?php echo get_phrase('live_class'); ?> : <?php echo $schdetails['title']; ?>
            </a>
...
<script>
    ...
    function start_zoom() {
        ...
        var USER_NAME      = "<?php echo $logged_user_details['student_first_name']." ".$logged_user_details['student_last_name']; ?>";
        var MEETING_NUMBER = "<?php echo $schdetails['meeting_id']; ?>";
        var PASSWORD       = "<?php echo $schdetails['password']; ?>";
...
alert('');
        ...
        var meetConfig = {
            ...
            userName: USER_NAME,
            passWord: PASSWORD,
            leaveUrl: "<?php echo site_url('home/lesson/'.slugify($schdetails['title']).'/'.$schdetails['batch_id']); ?>",
            role: 0
        };
