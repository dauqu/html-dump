		...
		<li class="side-nav-item">
			...
			<ul class="side-nav-second-level" aria-expanded="false">
                ...
                <li class = "<?php if($page_name == 'student_attendance_report') echo 'active'; ?>" >
                    <a href="<?php echo site_url('admin/student_attendance_report'); ?>">
                        <?php echo get_phrase('student_attendance_report');?>
                    </a>
                </li>
				<li class = "<?php if($page_name == 'batch_schedule_report') echo 'active'; ?>" >
                    <a href="<?php echo site_url('admin/batch_schedule_report'); ?>">
                        <?php echo get_phrase('batch_schedule_report');?>
                    </a>
                </li>
			</ul>
		</li>
