                    ...
                    <form class="" action="<?php echo site_url('admin/payment_settings/razorpay_settings'); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id = "razorpay_active" name="razorpay_active">
                                <option value="0" <?php if ($razorpay[0]->razorpay_active == 0) echo 'selected';?>> <?php echo get_phrase('no');?></option>
                                <option value="1" <?php if ($razorpay[0]->razorpay_active == 1) echo 'selected';?>> <?php echo get_phrase('yes');?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id = "razorpay_mode" name="razorpay_mode">
                                <option value="on" <?php if ($razorpay[0]->razorpay_mode == 'on') echo 'selected';?>> <?php echo get_phrase('on');?></option>
                                <option value="off" <?php if ($razorpay[0]->razorpay_mode == 'off') echo 'selected';?>> <?php echo get_phrase('off');?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id = "razorpay_currency" name="razorpay_currency" required>
                                ...
                                <?php
                                $razorpay_currencies = $this->crud_model->get_razorpay_supported_currencies();
                                foreach ($razorpay_currencies as $razorpay_currency):?>
                                    <option value="<?php echo $razorpay_currency['code'];?>"
                                        <?php if (get_settings('razorpay_currency') == $razorpay_currency['code'])echo 'selected';?>> <?php echo $razorpay_currency['code'];?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label><?php echo get_phrase('razorpay_secret_key'); ?></label>
                            <input type="text" name="razorpay_secret_key" class="form-control" value="<?php echo $razorpay[0]->razorpay_secret_key;?>" required />
                        </div>

                        <div class="form-group">
                            <label><?php echo get_phrase('razorpay_public_key'); ?></label>
                            <input type="text" name="razorpay_public_key" class="form-control" value="<?php echo $razorpay[0]->razorpay_public_key;?>" required />
                        </div>

                        <div class="form-group">
                            <label><?php echo get_phrase('live_secret_key'); ?></label>
                            <input type="text" name="razorpay_secret_live_key" class="form-control" value="<?php echo $razorpay[0]->razorpay_secret_live_key;?>" required />
                        </div>

                        <div class="form-group">
                            <label><?php echo get_phrase('live_public_key'); ?></label>
                            <input type="text" name="razorpay_public_live_key" class="form-control" value="<?php echo $razorpay[0]->razorpay_public_live_key;?>" required />
                        </div>
...
<div class="col-md-5">
    <div class="alert alert-info" role="alert">
       ...
       <p><?php echo get_phrase('please_make_sure_that').' "'.get_phrase('system_currency').'", '.'"'.get_phrase('paypal_currency').'" and '.'"'.get_phrase('stripe_currency').'" '.'" and '.'"'.get_phrase('razorpay_currency').'" '.get_phrase('are_same'); ?>.</p>
    </div>
</div>
</div>
