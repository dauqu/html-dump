                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="payumoney_public_key" name="payumoney_public_key" class="form-control">
                                                <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="payumoney_secret_key" name="payumoney_secret_key" class="form-control">
                                                <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
