                    ...
                    <div id="progressbarwizard">
                        ...
                        <div class="tab-content b-0 mb-0">
                            ...
                            <div class="tab-pane" id="basic_info">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="contact_no"><?php echo get_phrase('contact_no'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <input type="text" pattern="\d*" maxlength="20" class="form-control" id="contact_no" name="contact_no" value="<?php echo $user_data['contact_no']; ?>" required>
                                            </div>
                                        </div>
                            ...
                            <?php
                                ...
                                $payumoney_keys = json_decode($user_data['payumoney_keys'], true);
                             ?>
                            <div class="tab-pane" id="payment_info">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="payumoney_public_key"><?php echo get_phrase('payumoney_public_key'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" id="payumoney_public_key" name="payumoney_public_key" class="form-control" value="<?php echo $payumoney_keys[0]['public_live_key']; ?>">
                                                <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="payumoney_secret_key"><?php echo get_phrase('payumoney_secret_key'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" id="payumoney_secret_key" name="payumoney_secret_key" class="form-control" value="<?php echo $payumoney_keys[0]['secret_live_key']; ?>">
                                                <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
