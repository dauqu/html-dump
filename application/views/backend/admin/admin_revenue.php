        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row justify-content-md-center py-2">
                    ...
                    <div class="col-xl-12">
                        <form class="form" action="<?php echo site_url('admin/admin_revenue/filter') ?>" method="get">
                            <div class="row">
                            <div class="col-xl-6">
...
<div class="row" data-select2-id="7">
 ...
 <div class="col-6" data-select2-id="6">
					...
					<span> 
				<a href="<?php echo site_url('admin/admin_revenue_csv?student_id='.$selected_student_id.'&batch_id='.$selected_batch_id.'&start_date='.$start_date.'&end_date='.$end_date); ?>">Export</a>
                    ...
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo get_phrase('enrolled_batch'); ?></th>
                        ...
                        <tbody>
                            <?php foreach ($payment_history as $payment):
                             ?>
                                <tr class="gradeU">
					<td><?php echo $payment['student_first_name'].' '.$payment['student_last_name']; ?></td>

                                    <td><?php echo $payment['batch_title']; ?></td>
                                    <td><?php echo $payment['course_title']; ?></td>
				    <td><?php echo currency($payment['amount']); ?></td>

                                    <td><?php echo date('D, d-M-Y', $payment['enroll_date']); ?></td>
			            <td><?php echo date('D, d-M-Y', $payment['expiry_date']); ?></td>
