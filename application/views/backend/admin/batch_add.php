...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('add_new_batch'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
...
<div class="row justify-content-center">
    <div class="col-xl-7">
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <h4 class="mb-3 header-title"><?php echo get_phrase('batch_add_form'); ?></h4>

                    <form class="required-form" action="<?php echo site_url('admin/batch_actions/add'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="hours" name = "hours" min="1" max="20" required>
                        </div>

                        <div class="form-group">
                            <label for="total_number_of_sessions"><?php echo get_phrase('total_number_of_sessions'); ?><span class="required">*</span></label>
                            <input type="number"  class="form-control" id="total_number_of_sessions" name = "total_number_of_sessions" min="1" max="50" required>
                        </div>

                        <div class="form-group">
                            <label for="max_strength"><?php echo get_phrase('max_strength'); ?></label>
                            <input type="number" min="1" max="50" class="form-control" id="max_strength" name = "max_strength" onfocusout="validateMaxStrength()" >
                        </div>

                       <div class="form-group">
                            <label for="min_age"><?php echo get_phrase('min_age'); ?></label>
                            <input type="number" min="1" max="50" class="form-control" id="min_age" name = "min_age" required onfocusout="validateMinAge()">
                        </div>

                        <div class="form-group">
                            <label for="max_age"><?php echo get_phrase('max_age'); ?><span class="required">*</span></label>
                            <input type="number" min="1" max="50" class="form-control" id="max_age" name = "max_age" required onfocusout="validateMaxAge()">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" name="host_id" id="host_id" required>
                                ...
                                <?php foreach ($hosts as $host):?>
                                    ...
                                    <option value="<?php echo $host['id']; ?>"><?php echo $host['student_first_name'].' '.$host['student_last_name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="start_date" class="form-control date" id="start_date" data-toggle="date-picker" data-single-date-picker="true" value="<?php echo  date('m/d/Y', strtotime(date('m/d/Y')))?>">
                        </div>
			...
			<div class="form-group">
				<h5 class="mb-3 header-title"><?php echo get_phrase('price_details'); ?></h5>
                        ...
                        <div class="form-group">
                            <input type="checkbox" class="custom-control-input" name="is_free_batch" id="is_free_batch" value="1" onclick="isfreebatch()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="number_of_sessions" name = "number_of_sessions" placeholder="<?php echo get_phrase('enter_number_of_sessions'); ?>" min="1" max="20" >
                        </div>
                        <div class="form-group">
                            <label for="price"><?php echo get_phrase('batch_price').' ('.currency_code_and_symbol().')'; ?></label>
                            <input type="number" class="form-control" id="batch_price" name = "batch_price" placeholder="<?php echo get_phrase('enter_batch_price'); ?>" min="0">
                        </div>
                        <div class="form-group">
                            <input type="checkbox" class="custom-control-input" name="discount_flag" id="discount_flag" onclick="isdiscountedprice()">
